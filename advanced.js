...
positionsStudy.innerHTML = `
  ...
  <div class="position-list">
    <article class="study-position-card selected" data-position="lucena"><div class="position-card-head"><span>ENDGAME</span><b>18 players ready</b></div>${positionBoard({ b8: 'wK', b7: 'wP', d6: 'wR', f7: 'bK', a2: 'bR' })}<div class="position-copy"><h3>Lucena: build a bridge</h3><p>Convert the extra pawn as White, or find the most resilient defence as Black.</p></div><div class="position-match"><span class="avatar ece">18</span><span><b>Endgame players online</b><small>Same position · 10+5</small></span><i>Live</i></div><div class="side-choice"><button class="selected">Play White</button><button>Random side</button><button>Play Black</button></div><button class="position-action">Find a random opponent <b>→</b></button></article>
    <article class="study-position-card" data-position="minority"><div class="position-card-head"><span>MIDDLEGAME</span><b>11 players ready</b></div>${positionBoard({ a8:'bR',b8:'bN',c8:'bB',d8:'bQ',e7:'bB',f8:'bR',g8:'bK',f6:'bN',a7:'bP',b6:'bP',c7:'bP',d5:'bP',f7:'bP',g7:'bP',h6:'bP',a1:'wR',f1:'wB',d1:'wQ',e1:'wK',h1:'wR',c3:'wN',f3:'wN',h4:'wB',a2:'wP',b2:'wP',d4:'wP',e3:'wP',f2:'wP',g2:'wP',h2:'wP' })}<div class="position-copy"><h3>Minority attack</h3><p>Play the Carlsbad structure from either side and choose the right strategic plan.</p></div><div class="position-match"><span class="avatar mert">11</span><span><b>Middlegame players online</b><small>Same position · 15+10</small></span><i>Live</i></div><button class="position-action">Find a random opponent <b>→</b></button></article>
    <article class="study-position-card" data-position="attack"><div class="position-card-head"><span>OPENING</span><b>26 players ready</b></div>${positionBoard({ a8:'bR',c8:'bB',d8:'bQ',e8:'bK',h8:'bR',a7:'bP',b7:'bP',c7:'bP',d6:'bP',e5:'bP',f7:'bP',g7:'bP',h7:'bP',c6:'bN',f6:'bN',c5:'bB',a1:'wR',b1:'wN',c1:'wB',d1:'wQ',f1:'wR',g1:'wK',a2:'wP',b2:'wP',c2:'wP',d3:'wP',e4:'wP',f2:'wP',g2:'wP',h2:'wP',f3:'wN',c4:'wB' })}<div class="position-copy"><h3>Italian: pressure on f7</h3><p>Finish development, calculate the attack and practise converting initiative into a plan.</p></div><div class="position-match"><span class="avatar selin">26</span><span><b>Opening players online</b><small>Same position · 10+5</small></span><i>Live</i></div><button class="position-action">Find a random opponent <b>→</b></button></article>
  </div>`;
